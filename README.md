...
The original scripts this code was refactored from were written by Oliver
Křenek as part of his master thesis, supervised by Vít Průša
(<vit.prusa@matfyz.cuni.cz>); they are available in the thesis repository at
<https://github.com/krenekoliver/Masters-thesis>. Vít Průša is responsible for
the conceptualisation of the work.
